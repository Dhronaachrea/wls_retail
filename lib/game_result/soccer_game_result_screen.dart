...
class SoccerGameResultDetailsScreen extends StatefulWidget {
  SoccerContent? contentValue;

  SoccerGameResultDetailsScreen({Key? key, this.contentValue})
      : super(key: key);

  @override
  _SoccerGameResultDetailsScreenState createState() =>
      _SoccerGameResultDetailsScreenState();
}

class _SoccerGameResultDetailsScreenState
    extends State<SoccerGameResultDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    halfTimeOneXTwo = widget.contentValue!.marketWiseEventList.halfTimeOneXTwo;
    return WlsPosScaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              SoccerDrawResult(contentValue: widget.contentValue)
                  .pOnly(top: 10),
              Flexible(
                  child: Container(
                      padding: const EdgeInsets.all(15),
                      margin: const EdgeInsets.only(
                          top: 8, left: 10, right: 10, bottom: 60),
                      ...
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          oneXTwo != null && oneXTwo!.isNotEmpty
                              ? Flexible(
                            child: ListView.builder(
                              ...
                              : Container(),
                          halfTimeOneXTwo != null  && halfTimeOneXTwo!.isNotEmpty
                              ? Flexible(
                            child: ListView.builder(
