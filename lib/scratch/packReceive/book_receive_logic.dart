...
import 'package:wls_pos/scratch/packReceive/repository/book_receive_repository.dart';
...
class BookReceiveLogic {
  static Future<Result<dynamic>> callBookReceiveData(BuildContext context, Map<String, dynamic> param, var scratchList) async {
    ...
    String endUrl =  apiDetails['receiveBook']['url']; //bookReceiveUrl;
    ...
    dynamic jsonMap = await BookReceiveRepository.callBookReceive(context, param, header,scratchList.basePath, endUrl);
