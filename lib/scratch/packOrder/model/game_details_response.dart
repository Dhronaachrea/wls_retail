class GameDetailsResponse {
  ...
  List<Games>? games;
  dynamic? minimumBooksQuantity;
  dynamic? maximumBooksQuantity;

  GameDetailsResponse(
      {this.responseCode,
        this.responseMessage,
        this.games,
        this.minimumBooksQuantity,
        this.maximumBooksQuantity});
  ...
  GameDetailsResponse.fromJson(Map<String, dynamic> json) {
    ...
    minimumBooksQuantity = json['minimumBooksQuantity'];
    maximumBooksQuantity = json['maximumBooksQuantity'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['minimumBooksQuantity'] = this.minimumBooksQuantity;
    data['maximumBooksQuantity'] = this.maximumBooksQuantity;
    return data;
  }
}
